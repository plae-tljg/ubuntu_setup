...
static{dt7948.g(this.prototype,"editChannel",[t.tracked])}#o=void dt7948.i(this,"editChannel")
...
setupWhisperChannel=(0,c.default)((e,s)=>{const{topic:t}=this.args.model,{whisperer:r}=this.currentUser
...
notifyState=(0,c.default)((e,s)=>{const{topic:t,post:r,replyDirty:n}=this.args.model,i=this.isEdit?r:t
...
const r=`/discourse-presence/reply/${t.id}`,n=this.presence.getChannel(r)
this.replyChannel=n,n.subscribe(),s.cleanup(()=>n.unsubscribe())})
setupWhisperChannel=(0,c.default)((e,s)=>{const{topic:t}=this.args,{whisperer:r}=this.currentUser
if(!t||!r)return
const n=`/discourse-presence/whisper/${t.id}`,i=this.presence.getChannel(n)
this.whisperChannel=i,i.subscribe(),s.cleanup(()=>i.unsubscribe())})
get users(){return[...this.replyChannel?.users||[],...this.whisperChannel?.users||[]].filter(e=>e.id!==this.currentUser.id)}static{dt7948.n(this.prototype,"users",[t.cached])}static{(0,p.setComponentTemplate)((0,a.createTemplateFactory)({id:"gPqnSzAw",block:'[[[1,"\\n"],[41,[30,0,["currentUser"]],[[[1,"      "],[1,[30,0,["setupReplyChannel"]]],[1,"\\n      "],[1,[30,0,["setupWhisperChannel"]]],[1,"\\n\\n"],[41,[28,[32,0],[[30,0,["users","length"]],0],null],[[[1,"        "],[10,0],[14,0,"presence-users"],[12],[1,"\\n          "],[10,0],[14,0,"presence-avatars"],[12],[1,"\\n"],[42,[28,[31,2],[[28,[31,2],[[30,0,["users"]]],null]],null],null,[[[1,"              "],[8,[32,1],null,[["@user"],[[30,1]]],[["default"],[[[[1,"\\n                "],[1,[28,[32,2],[[30,1]],[["imageSize"],[[30,2]]]]],[1,"\\n              "]],[]]]]],[1,"\\n"]],[1]],null],[1,"          "],[13],[1,"\\n\\n          "],[10,1],[14,0,"presence-text"],[12],[1,"\\n            "],[10,1],[14,0,"description"],[12],[1,"\\n              "],[1,[28,[32,3],["presence.replying_to_topic"],[["count"],[[30,0,["users","length"]]]]]],[1,"\\n            "],[13],[1,"\\n            "],[10,1],[14,0,"wave"],[12],[1,"\\n              "],[10,1],[14,0,"dot"],[12],[1,"."],[13],[1,"\\n              "],[10,1],[14,0,"dot"],[12],[1,"."],[13],[1,"\\n              "],[10,1],[14,0,"dot"],[12],[1,"."],[13],[1,"\\n            "],[13],[1,"\\n          "],[13],[1,"\\n        "],[13],[1,"\\n"]],[]],null]],[]],null],[1,"  "]],["user","@avatarSize"],["if","each","-track-array"]]',moduleName:"/var/www/discourse/frontend/discourse/discourse/plugins/discourse-presence/discourse/components/topic-presence-display.js",scope:()=>[n.gt,i.default,o.default,l.i18n],isStrictMode:!0}),this)}}e.default=u}),define("discourse/plugins/discourse-presence/discourse/connectors/before-composer-controls/presence",["exports","discourse/plugins/discourse-presence/discourse/components/composer-presence-display","@ember/component","@ember/template-factory","@ember/component/template-only"],function(e,s,t,r,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const i=(0,t.setComponentTemplate)((0,r.createTemplateFactory)({id:"8ZBRgEHm",block:'[[[1,"\\n  "],[10,0],[14,0,"before-composer-controls-outlet presence"],[12],[1,"\\n    "],[8,[32,0],null,[["@model"],[[30,1,["model"]]]],null],[1,"\\n  "],[13],[1,"\\n"]],["@outletArgs"],[]]',moduleName:"/var/www/discourse/frontend/discourse/discourse/plugins/discourse-presence/discourse/connectors/before-composer-controls/presence.js",scope:()=>[s.default],isStrictMode:!0}),(0,n.default)(void 0,"presence:Presence"))
e.default=i}),define("discourse/plugins/discourse-presence/discourse/connectors/topic-above-footer-buttons/presence",["exports","@glimmer/component","@ember/helper","@ember/template","discourse/lib/avatar-utils","discourse/plugins/discourse-presence/discourse/components/topic-presence-display","@ember/component","@ember/template-factory"],function(e,s,t,r,n,i,o,c){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const l="small"
class p extends s.default{get avatarDimensions(){return(0,n.translateSize)(l)}static{(0,o.setComponentTemplate)((0,c.createTemplateFactory)({id:"DsqpoTEd",block:'[[[1,"\\n    "],[10,0],[15,5,[28,[32,0],[[28,[32,1],["--avatar-min-height: ",[30,0,["avatarDimensions"]],"px"],null]],null]],[14,0,"topic-above-footer-buttons-outlet presence"],[12],[1,"\\n      "],[8,[32,2],null,[["@topic","@avatarSize"],[[30,1,["model"]],[32,3]]],null],[1,"\\n    "],[13],[1,"\\n  "]],["@outletArgs"],[]]',moduleName:"/var/www/discourse/frontend/discourse/discourse/plugins/discourse-presence/discourse/connectors/topic-above-footer-buttons/presence.js",scope:()=>[r.htmlSafe,t.concat,i.default,l],isStrictMode:!0}),this)}}e.default=p}),define("discourse/plugins/discourse-presence/discourse/services/composer-presence-manager",["exports","@ember/runloop","@ember/service","discourse/lib/environment"],function(e,s,t,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
